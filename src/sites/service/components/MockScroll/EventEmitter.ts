...
export default class EventEmitter {
     ...
     * registerType
     */
    public registerType(names: string[]) {
     ...
     * on
     */
    public on(type: string, fn: Function, context: any = this) {
        this._checkInTypes(name);
        if (!this.events[type]) {
            this.events[type] = [];
        }
     ...
     * once
     */
    public once(type: string, fn: Function, context: any = this) {
